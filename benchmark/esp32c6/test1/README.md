...
1. **Задача счётчика**: инкрементирует счётчик на 1000 в цикле
...
- `counter_task_*`: Функции для задачи счётчика, которая инкрементирует AtomicU32 на 1000 в каждой итерации. Задача останавливается после достижения значения 100000.
