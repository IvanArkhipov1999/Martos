...
pub fn task_waker() -> Waker {
    fn raw_clone(_: *const ()) -> RawWaker { RawWaker::new(core::ptr::null::<()>(), &NOOP_WAKER_VTABLE) }
    ...
    static NOOP_WAKER_VTABLE: RawWakerVTable = RawWakerVTable::new(raw_clone, raw_wake, raw_wake_by_ref, raw_drop);
