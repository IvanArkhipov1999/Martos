...
use martos::{init_system, get_esp_now};
...
fn print_sync_stats(sync_manager: &TimeSyncManager) {
    ...
    for peer in peers {
        println!("  Peer 0x{:08X}: quality={:.2}, diff={}μs, syncs={}", 
